...
exports.DashboardPreferencesModel = exports.DashboardStatsModel = exports.DashboardLayoutModel = void 0;
...
const dashboardLayoutSchema = new mongoose_1.Schema({
...
const quickActionSchema = new mongoose_1.Schema({
    id: { type: String, required: true },
    title: { type: String, required: true },
...
const dashboardPreferencesSchema = new mongoose_1.Schema({
...
exports.DashboardLayoutModel = mongoose_1.default.model('DashboardLayout', dashboardLayoutSchema);
exports.DashboardStatsModel = mongoose_1.default.model('DashboardStats', dashboardStatsSchema);
exports.DashboardPreferencesModel = mongoose_1.default.model('DashboardPreferences', dashboardPreferencesSchema);
