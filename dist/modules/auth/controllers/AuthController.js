...
class AuthController {
    ...
    async updateProfile(request, reply) {
        try {
            ...
            const updatedProfile = await this.authService.updateProfile(request.user._id, request.body);
            reply.status(200).send({
                success: true,
    ...
    async changePassword(request, reply) {
        try {
            ...
            await this.authService.changePassword(request.user._id, currentPassword, newPassword);
            reply.status(200).send({
                success: true,
